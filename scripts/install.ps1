...
$BaseUrl = "https://github.com/struckchure/sentinel/releases/download/$Version"

# Define the file names (adjust these as needed)
$Windows_AMD64 = "sentinel_Windows_x86_64.zip"
$Windows_ARM64 = "sentinel_Windows_arm64.zip"
...
$DestDir = "$env:USERPROFILE\.sentinel\bin"
...
# Extract the downloaded file to the .sentinel\bin directory
...
# Add .sentinel\bin to the PATH if it's not already there
$PathEntry = "$DestDir"
